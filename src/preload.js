...
contextBridge.exposeInMainWorld("api", {
  ...
  getStashFilesFromCommit: (directory, commitHash) => ipcRenderer.invoke("get-stash-files-from-commit", directory, commitHash),
  getCommitFileDiff: (directory, hash, filePath) => ipcRenderer.invoke("get-commit-file-diff", directory, hash, filePath),
  getStashFileDiff: (directory, commitHash, filePath) => ipcRenderer.invoke("get-stash-file-diff", directory, commitHash, filePath),
  ...
  getFileContentBase64: (directory, filePath) => ipcRenderer.invoke("get-file-content-base64", directory, filePath),
